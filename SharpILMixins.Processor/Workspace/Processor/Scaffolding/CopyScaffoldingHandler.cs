    ...
    public class CopyScaffoldingHandler
    {
            ...
            ObfuscationMap? obfuscationMap = null)
        {
            ...
            foreach (var typeDef in nonMixinTypes)
            {
                ...
                if (typeDef.GetCustomAttribute<DescriptionAttribute>()?.Description == GeneratorMixinRelation.GeneratedByAttribute) continue;
            ...
            ObfuscationMap? obfuscationMap = null)
        {
            ...
            {
                var entry = obfuscationMap.GetEntriesForType(ObfuscationMapEntryType.Type).FirstOrDefault(c => c.TargetMember == target);
